...
define internal i64 @Microsoft__Quantum__Qir__Emission__BellState__body() {
entry:
  ...
  %10 = call double @Microsoft__Quantum__Math__PI__body()
  ...
  store %Qubit* %14, %Qubit** %9, align 8
  call void @Microsoft__Quantum__Intrinsic__R1__ctl(%Array* %0, { double, %Qubit* }* %7)
  ...
  %res = call %Result* @Microsoft__Quantum__Intrinsic__M__body(%Qubit* %17)
  %18 = call %Result* @__quantum__rt__result_get_one()
  %19 = call i1 @__quantum__rt__result_equal(%Result* %res, %Result* %18)
  br i1 %19, label %then0__1, label %else__1
...
continue__1:                                      ; No predecessors!
  %20 = call %String* @__quantum__rt__string_create(i8* getelementptr inbounds ([28 x i8], [28 x i8]* @0, i32 0, i32 0))
  call void @__quantum__rt__array_update_alias_count(%Array* %qubits, i32 -1)
  call void @__quantum__rt__array_update_reference_count(%Array* %0, i32 -1)
  call void @__quantum__rt__tuple_update_reference_count(%Tuple* %6, i32 -1)
  call void @__quantum__rt__result_update_reference_count(%Result* %res, i32 -1)
...
entry:
  ...
  call void @__quantum__rt__array_update_alias_count(%Array* %__controlQubits__, i32 1)
  %pauli__1 = load i2, i2* @PauliI, align 1
  ...
  store i2 %pauli__1, i2* %10, align 1
...
entry:
  ...
  %pauli__1 = load i2, i2* @PauliI, align 1
  %theta__2 = fneg double %theta
  call void @__quantum__qis__r__body(i2 %pauli__1, double %theta__2, %Qubit* %qubit)
  ret void
}

define internal void @Microsoft__Quantum__Intrinsic__R1__adj(double %theta, %Qubit* %qubit) {
entry:
  %pauli = load i2, i2* @PauliI, align 1
  %theta__1 = fneg double %theta
  call void @__quantum__qis__r__adj(i2 %pauli, double %theta__1, %Qubit* %qubit)
  %pauli__1 = load i2, i2* @PauliZ, align 1
  call void @__quantum__qis__r__adj(i2 %pauli__1, double %theta, %Qubit* %qubit)
  ret void
}
...
define i64 @Microsoft__Quantum__Qir__Emission__BellState__Interop() #0 {
entry:
  %0 = call i64 @Microsoft__Quantum__Qir__Emission__BellState__body()
  ret i64 %0
}

define void @Microsoft__Quantum__Qir__Emission__BellState() #1 {
entry:
  %0 = call i64 @Microsoft__Quantum__Qir__Emission__BellState__body()
