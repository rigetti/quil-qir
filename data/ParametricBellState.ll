...
entry:
  ...
  tail call void @__quantum__qis__rx(double 0x3FE921FB54442D18, %Qubit* %2)
  %3 = tail call i8* @__quantum__rt__array_get_element_ptr_1d(%Array* %qubits, i64 1)
  %4 = bitcast i8* %3 to %Qubit**
  %5 = load %Qubit*, %Qubit** %4, align 8
  %6 = tail call i8* @__quantum__rt__array_get_element_ptr_1d(%Array* %qubits, i64 0)
